...
<div class="card w-50 mx-auto mt-5">
  <div class="card-body">
    ...
    <div class="container mt-5 p-lg-5 bg-light">
      ...
      <form action="{{ route('back.update', ['id' => $notice->id]) }}" method="POST">
        @csrf
        <!--タイトル-->
        <div class="form-row">
          <div class="col-md-12 mb-3">
            <label for="title">タイトル</label>
            <input name="title" type="text" class="form-control" id="title" placeholder="タイトル" value="{{ $notice->title }}">
          </div>
        </div>
        <!--/タイトル-->
        ...
        <div class="form-group mb-3">
          ...
          <textarea class="form-control" name="body" id="body" rows="3" placeholder="コメントの記入をお願いします。">{{ $notice->body }}</textarea>
        </div>
        <!--/コメント-->
